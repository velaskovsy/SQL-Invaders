...
switch(room) {
    case rm_play0: // Nivel 1
        preguntas = [
            // --- Preguntas originales del código ---
            {
            ...
            // --- NUEVAS PREGUNTAS QUE SE AGREGAN ---
            {
    ...
    case rm_play2: // Nivel 3
        preguntas = [
            ...
            },
            {
                ...
                correcta: 0,
                feedback: "Se combinan planetas, batallas e invasores. SUM() y COUNT() permiten medir rayos e invasores, y HAVING filtra según las condiciones."
            }
        ];
    break;
...
crearPregunta = function(){
	...
	// Eliminar la pregunta del array para que no se repita
	array_delete(preguntas, pregunta_actual, 1);
