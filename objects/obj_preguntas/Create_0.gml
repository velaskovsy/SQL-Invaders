...
switch(room) {
    case rm_play0: // Nivel 1
        preguntas = [
            {
                texto: "La nave registra los disparos. Tabla: disparos(planeta, cantidad). ¿Cuál consulta muestra el total de disparos por planeta?",
                opciones: [
            ...
            {
                texto: "Queremos saber el número de pilotos por planeta. Tabla: pilotos(planeta, id).",
                opciones: [
            ...
            {
                texto: "¿Cómo mostramos el promedio de rayos disparados por nave? Tabla: disparos(nave, rayos).",
                opciones: [
            ...
            {
                texto: "Los planetas tienen registros de escudos. Tabla: registros(planeta, escudo). Mostrar escudo máximo por planeta.",
                opciones: [
            ...
            {
                texto: "Tabla: disparos(planeta, rayos). ¿Cómo mostramos la suma de rayos disparados por cada planeta?",
                opciones: [
            ...
            {
                texto: "Obtener el promedio de energía por nave. Tabla: naves(nave, energia).",
                opciones: [
            ...
            {
                texto: "Número de pilotos por rango. Tabla: pilotos(rango, id).",
                opciones: [
            ...
            {
                texto: "Mostrar el máximo de combustible usado por modelo de nave. Tabla: naves(modelo, combustible).",
                opciones: [
            ...
            {
                texto: "Promedio de edad de comandantes por planeta. Tabla: comandantes(planeta, edad).",
                opciones: [
    ...
    case rm_play1: // Nivel 2
        preguntas = [
            {
                texto: "Tablas: comandantes(id, nombre), naves(id_comandante). Listar comandantes con más de 5 naves.",
                opciones: [
            ...
            {
                texto: "Tablas: planetas(id, nombre), ataques(id_planeta, rayos). Mostrar planetas atacados con más de 100 rayos.",
                opciones: [
            ...
            {
                texto: "Tablas: sectores(id, nombre), estaciones(id_sector, energia). Mostrar sectores con promedio de energía mayor a 2000.",
                opciones: [
            ...
            {
                texto: "Tablas: naves(id, modelo), pilotos(id_nave). Mostrar modelos de nave con al menos 3 pilotos asignados.",
                opciones: [
            ...
            {
                texto: "Tablas: planetas(id, nombre), invasores(id_planeta, tipo). Planetas con más de 2 invasores tipo élite.",
                opciones: [
            ...
            {
                texto: "Tablas: comandantes(id, nombre), naves(id_comandante). Comandantes con más de 3 naves asignadas.",
                opciones: [
            ...
            {
                texto: "Tablas: planetas(id, nombre), ataques(id_planeta, rayos). Planetas donde la suma de ataques supera 50.",
                opciones: [
            ...
            {
                texto: "Tablas: sectores(id, nombre), estaciones(id_sector, energia). Sectores con promedio de energía superior a 1500.",
                opciones: [
            ...
            {
                texto: "Tablas: naves(id, modelo), pilotos(id_nave). Mostrar modelos de nave con al menos 2 pilotos.",
                opciones: [
            ...
            {
                texto: "Tablas: planetas(id, nombre), invasores(id_planeta, tipo). Planetas con más de 1 invasor tipo élite.",
                opciones: [
    ...
    case rm_play2: // Nivel 3
        preguntas = [
            {
                texto: "Tablas: naves(id, modelo), escuadrones(id, nombre), victorias(id_nave). Naves por modelo y escuadrón con más de 10 victorias.",
                opciones: [
            ...
            {
                texto: "Tablas: sectores(id, nombre), estaciones(id_sector), mediciones(id_estacion, energia). Sectores con más de 5 estaciones y energía promedio > 2000.",
                opciones: [
                    "SELECT sector, COUNT(), AVG(energia) FROM estaciones WHERE COUNT() > 5 AND AVG(energia) > 2000;",
                    "SELECT s.nombre, COUNT(e.id), AVG(m.energia) FROM sectores s JOIN estaciones e ON s.id=e.id_sector JOIN mediciones m ON e.id=m.id_estacion GROUP BY s.nombre HAVING COUNT(e.id) > 5 AND AVG(m.energia) > 2000;",
            ...
            {
                texto: "Tablas: comandantes(id, nombre), naves(id_comandante), batallas(id_nave, derrotas). Mostrar comandantes con más de 3 naves y menos de 2 derrotas.",
                opciones: [
            ...
            {
                texto: "Tablas: planetas(id, nombre), batallas(id_planeta, rayos), invasores(id_batalla). Mostrar planetas donde se lanzaron más de 50 rayos y menos de 5 invasores llegaron vivos.",
                opciones: [
            ...
            {
                texto: "Tablas: naves(id, modelo), pilotos(id_nave), pruebas(id_nave, velocidad). Modelos de nave con velocidad promedio > 5000 y más de 10 pilotos asignados.",
                opciones: [
                    ...
                    "SELECT n.modelo, AVG(pr.velocidad), COUNT(p.id) FROM naves n JOIN pilotos p ON n.id=p.id_nave JOIN pruebas pr ON n.id=pr.id_nave GROUP BY n.modelo HAVING AVG(pr.velocidad) > 5000 AND COUNT(p.id) > 10;"
                ],
                correcta: 3,
            ...
            {
                texto: "Tablas: comandantes(id, nombre), escuadrones(id_comandante), naves(id_escuadron, victorias). Comandantes con más de 2 escuadrones y naves con más de 5 victorias.",
                opciones: [
            ...
            {
                texto: "Tablas: ciudades(id, nombre), ataques(id_ciudad, fallidos), defensas(id_ciudad, exitosas). Ciudades con promedio de ataques fallidos < 2 y defensas exitosas > 8.",
                opciones: [
            ...
            {
                texto: "Tablas: naves(id, tipo, id_region, velocidad), misiones(id_nave), regiones(id, nombre). Tipos de nave y regiones con misiones > 4 o velocidad promedio > 8000.",
                opciones: [
            ...
            {
                texto: "Tablas: planetas(id, nombre), batallas(id_planeta, rayos), invasores(id_batalla). Planetas con más de 40 rayos lanzados y menos de 3 invasores sobrevivientes.",
                opciones: [
            ...
            {
                texto: "Tablas: naves(id, modelo, tripulantes), recursos(id_nave, costo_total). Modelos de nave con promedio de tripulantes > 5 y recursos totales usados > 20000.",
                opciones: [
